  ...
  fs: {
    ...
    exists: async (path: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '检查文件存在失败'
        }
      }
    },
    stat: async (path: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '获取文件状态失败'
        }
      }
    },
  ...
  clipboard: {
    ...
    readImage: async () => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '读取剪贴板图片失败'
        }
      }
    },
    writeImage: async (dataUrl: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '写入剪贴板图片失败'
        }
      }
    },
    subscribe: async () => {
  ...
  system: {
    getInfo: async () => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '获取系统信息失败'
        }
      }
    },
    openExternal: async (url: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '打开外部链接失败'
        }
      }
    },
    showInFolder: async (path: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '显示文件夹失败'
        }
      }
    },
    paste: async () => {
  ...
  sidebar: {
    setCollapsed: async (collapsed: boolean) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '设置侧边栏状态失败'
        }
      }
    }
  },
  settings: {
    ...
    setShortcut: async (key: string, value: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '设置快捷键失败'
        }
      }
    },
    setPluginShortcut: async (pluginId: string, value: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '设置插件快捷键失败'
        }
      }
    },
  ...
  apps: {
    ...
    refresh: async () => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '刷新应用列表失败'
        }
      }
    },
    getIcon: async (appPath: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '获取应用图标失败'
        }
      }
    },
    preloadIcons: async (appPaths: string[]) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '预加载图标失败'
        }
      }
    }
  },
  db: {
    ...
    addRecent: async (pluginId: string) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '添加最近使用失败'
        }
      }
    },
    ...
    clearRecents: async () => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '清除最近使用失败'
        }
      }
    }
  },
  tab: {
    showContextMenu: async (tabId: string, index: number, total: number) => {
      ...
      try {
        ...
        return {
          success: false,
          message: error instanceof Error ? error.message : '显示上下文菜单失败'
        }
      }
    }
  }
